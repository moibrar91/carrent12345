...
<html>
    ...
    <!-------     LOGIN / LOGOUT FORM END           --------->
        ...
        <div class="wrapper">
            <div id="banner">
                <img id='banner' src="https://images.unsplash.com/photo-1493238792000-8113da705763?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8Y2FyfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60">
            </div>
